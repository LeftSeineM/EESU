...
def document_xml() -> str:
    parts = [
        ...
        list_p("做一套面向四个大家庭的公共档案，把文艺、体育、联络、全发的工作都纳入同一套展示体系。"),
        ...
        table(
            [
                ...
                ["全发中心", "全面发展、权益反馈、成长支持和师生沟通", "课程研讨、权益声音、成长项目、反馈闭环、长期建设成果"],
            ],
            [1700, 3600, 4060],
        ),
        heading("四、核心功能倾向", 1),
